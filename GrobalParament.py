...
PreprocessNewfilePath="C:/Users/zhongxing/fileSearch/test/newfiles"#统一编码格式后的文件位置
PreprocessResultDir="C:/Users/zhongxing/fileSearch/test"#预处理文件目录
PreprocessResultName="pro_res.txt"                               #预处理文件名
ResultFileNameDir="C:/Users/zhongxing/fileSearch/test/result"  #搜索结果文件目录
